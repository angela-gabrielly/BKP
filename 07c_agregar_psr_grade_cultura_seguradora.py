# -*- coding: utf-8 -*-
"""Agrega pontos PSR em grades por cultura e seguradora.

Execute 07a_gerar_pontos_psr.py antes.
Saída: D:\AZ\PSR\data\vetores\psr_grades_culturas_2020_2024.gpkg
"""
...
ARQUIVO_GPKG = PASTA_VETORES / "psr_grades_culturas_2020_2024.gpkg"
ARQUIVO_AUDITORIA = PASTA_QUALIDADE / "psr_auditoria_grades_culturas_2020_2024.csv"
...
for nome_grade, config in GRADES.items():
    ...
    for ano in ANOS:
        ...
        salvar_camada(gdf_cult, ARQUIVO_GPKG, f"{nome_grade}_{ano}_cult")
        if GERAR_CAMADAS_CULTSEG:
            salvar_camada(gdf_cultseg, ARQUIVO_GPKG, f"{nome_grade}_{ano}_cultseg")
    ...
    salvar_camada(gdf_cult, ARQUIVO_GPKG, f"{nome_grade}_acum_cult")
    if GERAR_CAMADAS_CULTSEG:
        salvar_camada(gdf_cultseg, ARQUIVO_GPKG, f"{nome_grade}_acum_cultseg")
...
print("\n" + "=" * 100)
print("GRADES POR CULTURA E SEGURADORA GERADAS COM SUCESSO")
print("=" * 100)
